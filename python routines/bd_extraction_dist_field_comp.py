...
def bd_extraction(image):
    ...
    print(lambda_1)
    print(lambda_2)
    ls = morphological_chan_vese(image, 50, init_level_set=dist_image, lambda1=abs(lambda_1),lambda2=abs(lambda_2),smoothing=0)
...
raw_writer.SetFileName(output_path_name+'/chamf_distance_'+main_file_name)
